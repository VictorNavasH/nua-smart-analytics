...
export function StatCard({ 
  ...
  return (
    <div className={cn(
      "relative p-5 rounded-lg border bg-card text-card-foreground shadow-card hover:shadow-card-hover transition-all duration-300 animate-fade-in",
      ...
      <div className={cn(
        "mt-3 text-2xl font-bold transition-all hover:scale-105 duration-200",
        highlight && "text-nua-turquoise"
      )}>{value}</div>
